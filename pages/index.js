...
<div>
  <div class="battle-arena" style="margin-bottom:9px">
    <div id="arena-scene" style="width:100%;height:200px;position:relative;background:url('/dungeon-bg.png') center 85%/cover no-repeat;border-radius:10px;overflow:hidden">
